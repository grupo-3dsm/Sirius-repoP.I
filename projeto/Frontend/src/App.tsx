...
const App: React.FC = () => {
  ...
  const {
    data: nearbyPositions  } = useQuery([clickedPos.lat, clickedPos.lng], () => fetchNearbyPlaces(clickedPos.lat, clickedPos.lng), {
  ...
  const {
    data: markerWeather,
    isLoading: isLoadingMarkerWeather  } = useQuery([selectedMarker.id], () => fetchWeather(selectedMarker), {
